...
for epoch in range(num_epochs):
    ...
    for batch_of_keypoints_cropped, batch_of_keypoints_original, scaleFactor, x_displacement, y_displacement in dataloader:
        ...
        #batch_of_real_pairs_cpu = data.to(device)

        #batch_of_keypoints_cropped, batch_of_keypoints_original = batch_of_real_pairs[:, 0], batch_of_real_pairs_cpu[:, 1]
        ...
        print("Shape of batch_of_keypoints_cropped: ", batch_of_keypoints_cropped.shape)

        print("Shape of keypoints_original: ", batch_of_keypoints_original.shape)

...
MODELPATH="data/output/H36M/model/model_epoch3_batch0.pt"
#MODELPATH="dynamicData/models/H36M_GAN_epoch7_batch2000/H36M_GAN_epoch7_batch2000.pt"

MODEL="models"
ONLY15=1
BODY_MODEL="OPENPOSE_15"
NORMALIZATION="none" #"center_scale", "basic", "none" 
KEYPOINT_RESTORATION=0



python inference.py $DATASET_CROPPED $DATASET_ORIGINAL $OUTPUTPATH $DATASET_CHARADE $DATASET_CHARADE_IMAGES $DATASET_TEST $DATASET_TEST_IMAGES $MODELPATH $MODEL $ONLY15 $BODY_MODEL $NORMALIZATION $KEYPOINT_RESTORATION

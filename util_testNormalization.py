...
#poseUtils.draw_pose(background, normalized_keypoints, -1, bodyModel.POSE_BODY_25_PAIRS_RENDER_GP, openPoseUtils.POSE_BODY_25_COLORS_RENDER_GPU, False)
keypointsNP = poseUtils.keypoints2Numpy(normalized_keypoints)
poseUtils.draw_pose_scale(background, keypointsNP, -1, bodyModel.POSE_BODY_25_PAIRS_RENDER_GP, openPoseUtils.POSE_BODY_25_COLORS_RENDER_GPU, False, 1/200)        	

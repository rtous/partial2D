    ...
    def __iter__(self):
        ...
        for keypoints_original in self.scandirIterator:
            ...
            if len_buffer_originals == 65536:
                ...
                for buffered_keypoints_original in enumerate(buffer_originals):
                    ...
                    for v_idx, keypoints_cropped in enumerate(variations):    
                        ...
                        buffer.append((keypoints_croppedFlatFloatTensor, keypoints_original_flat, confidence_values, scaleFactor, x_displacement, y_displacement, "unknown file"))
                        if len(buffer) == 32768: #65536
                            print("shuffle buffer full, yielding...")
                            random.shuffle(buffer)
                            for tup in buffer:
                                yield tup[0], tup[1], tup[2], tup[3], tup[4], tup[5], tup[6]
                            print("yielded all from shuffle buffer")
                            buffer = []

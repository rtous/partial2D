...
OUTPUTPATH="data/output/H36M_AE"
...
MODEL="models" #models models_mirror models_simple models_AE
...
MODELPATH="data/output/H36M_AE/model/model_epoch40_batch0.pt"
ONLY15=1

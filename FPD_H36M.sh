...
NUMJOINTS=15
DISCARDINCOMPLETEPOSES=1

python FPD_H36M.py $DATASET_CANDIDATE $DATASET_CROPPED $DATASET_ORIGNAL $DATASET_CANDIDATE_MAX $DATASET_REFERENCE $DATASET_REFERENCE_MAX $NUMJOINTS $DISCARDINCOMPLETEPOSES

...
def map_to_pixel3(point3d,focal_distance, ppx, ppy, scale_x, scale_y, offsetx, offsety, angle):
	...
	camera_intrinsic_matrix = [[fx, -fx*1/math.tan(angle), ppx], 
	                           [0, fy/math.sin(angle), ppy], 
	                           [0, 0, 1]]
...
def map_to_pixel2(point3d,focal_distance, ppx, ppy, scale_x, scale_y):
	fx = focal_distance*scale_x
	fy = focal_distance*scale_y
...
def map_to_pixel1(point3d,w,h,projection,view):
...
for point3d in points3d:
	#pixel = map_to_pixel(point3d,10,10,projection,view )
	pixel = map_to_pixel2(point3d, focal_distance,focal_pane_width/2,focal_pane_height/2, scalex, scaley)
	#pixel = map_to_pixel3(point3d, focal_distance, focal_pane_width/2, focal_pane_height/2, scalex, scaley, offsetx, offsety, angle)

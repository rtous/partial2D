...
DATASET_ORIGINAL="/mnt/f/datasets/pose/H36M/H36M/H36M/"
...
DATASET_TEST_IMAGES="/mnt/f/datasets/pose/H36M/ECCV2018/ECCV18_Challenge/Train/IMG/"
HEATMAP_SIZE=64


python train_heatmaps_DCGAN.py $DATASET_CROPPED $DATASET_ORIGINAL $OUTPUTPATH $DATASET_CHARADE $DATASET_CHARADE_IMAGES $DATASET_TEST $DATASET_TEST_IMAGES $HEATMAP_SIZE

...
MODEL="models_heatmaps_DCGAN"
ONLY15=1
HEATMAP_SIZE=64

python inference_heatmaps_DCGAN.py $DATASET_CROPPED $DATASET_ORIGINAL $OUTPUTPATH $DATASET_CHARADE $DATASET_CHARADE_IMAGES $DATASET_TEST $DATASET_TEST_IMAGES $MODELPATH $MODEL $ONLY15 $HEATMAP_SIZE
